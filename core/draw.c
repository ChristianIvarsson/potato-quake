...
__IRAM static rectdesc_t    r_rectdesc;

__IRAM byte     *draw_chars;				// 8*8 graphic characters
__IRAM qpic_t   *draw_disc;
__IRAM qpic_t   *draw_backtile;
