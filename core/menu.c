...
__IRAM qboolean m_entersound; // play after drawing a frame, so caching
					   // won't disrupt the sound
__IRAM qboolean m_recursiveDraw;
...
__IRAM int m_singleplayer_cursor;
...
__IRAM int load_cursor; // 0 < load_cursor < MAX_SAVEGAMES

#define MAX_SAVEGAMES 6
char m_filenames[MAX_SAVEGAMES][SAVEGAME_COMMENT_LENGTH + 1];
__IRAM int loadable[MAX_SAVEGAMES];
...
__IRAM int keys_cursor;
__IRAM int bind_grab;
...
__IRAM static int msgNumber;
__IRAM static int m_quit_prevstate;
__IRAM static qboolean wasInMenus;
...
__IRAM int startepisode;
__IRAM int startlevel;
__IRAM int maxplayers;
__IRAM qboolean m_serverInfoMessage = false;
...
/* SEARCH MENU */
/*
__IRAM qboolean searchComplete = false;
...
/* SLIST MENU */
/*
__IRAM int slist_cursor;
__IRAM qboolean slist_sorted;
