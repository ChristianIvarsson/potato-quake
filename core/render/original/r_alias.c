...
__IRAM mtriangle_t		*ptriangles;
__IRAM affinetridesc_t	r_affinetridesc;

void *			acolormap;	// FIXME: should go away

__IRAM trivertx_t		*r_apverts;

// TODO: these probably will go away with optimized rasterization
__IRAM mdl_t				*pmdl;
vec3_t				r_plightvec;
__IRAM int					r_ambientlight;
float				r_shadelight;
__IRAM aliashdr_t			*paliashdr;
__IRAM finalvert_t			*pfinalverts;
__IRAM auxvert_t			*pauxverts;
static float		ziscale;
__IRAM static model_t		*pmodel;

static vec3_t		alias_forward, alias_right, alias_up;

__IRAM static maliasskindesc_t	*pskindesc;

__IRAM int				r_amodels_drawn;
__IRAM int				a_skinwidth;
__IRAM int				r_anumverts;
...
__IRAM static aedge_t	aedges[12] = {
{0, 1}, {1, 2}, {2, 3}, {3, 0},
{4, 5}, {5, 6}, {6, 7}, {7, 4},
{0, 5}, {1, 4}, {2, 7}, {3, 6}
};
