...
void R_PrintTimes (void)
{
	...
	Con_Printf ("%5.1f ms %3i/%3i/%3i poly %3i (max %3i) surf \n",
				ms, c_faceclip, r_polycount, r_drawnpolycount, c_surf, maxSurf);
	c_surf = 0;
}
