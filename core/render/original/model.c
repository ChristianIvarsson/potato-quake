...
__IRAM model_t	*loadmodel;
__RTC_FAST char	loadname[32];	// for hunk tags
...
__IRAM model_t	*mod_known;
__IRAM int		mod_numknown;
...
void Mod_LoadLeafs (lump_t *l)
{
	...
	for ( i=0 ; i<count ; i++, in++, out++)
	{
		...
		assert(in->nummarksurfaces < 65535);
